...
//
// Every [PENDING] stays [PENDING]. We do not list a certificate we do not hold.

import { SITE, REGISTRATIONS } from '../site.js';
      ...
      <div class="wrap" style="padding-top:64px;padding-bottom:54px">
        <div class="split-even" style="grid-template-columns:minmax(0,1.1fr) minmax(0,.9fr);align-items:start">
          ...
          <div class="card card-float" style="padding:28px 28px 24px;gap:0">
            ...
            <div class="rows">
              <div><p class="smaller" style="font-weight:600;margin-bottom:2px">Registered name</p><p style="font-size:15px;font-weight:700;color:var(--navy)">${esc(SITE.name)} [LIMITED?]</p></div>
              <div><p class="smaller" style="font-weight:600;margin-bottom:2px">Registered office</p><p style="font-size:15px;font-weight:700;color:var(--navy)">${esc(SITE.address)}, Nairobi</p></div>
              <div><p class="smaller" style="font-weight:600;margin-bottom:2px">Procurement contact</p><p style="font-size:15px;font-weight:700;color:var(--navy)">[NAME], Director</p></div>
...
${REGISTRATIONS.map(row).join('\n')}
      ...
      <p class="small" style="margin-top:18px;max-width:70ch">Certified copies of any document above are supplied with a bid on request. Where a status reads [PENDING], the application is in progress and we will say where it has reached — we do not list a certificate we do not hold.</p>
    </section>
    ...
    <section class="band-tint" style="margin-top:72px" aria-label="Capability statement and references">
      <div class="wrap sec-tight split-even" style="align-items:start">
        <div class="stack stack-5">
          ...
          <a class="btn" href="/contact" style="align-self:flex-start;margin-top:4px">${ICONS.download(17)} Download (PDF, [X] MB)</a>
        </div>
        ...
        <div class="stack stack-5">
          ...
          <div class="stack stack-4">
            <div class="card" style="padding:22px 22px 20px;gap:6px">
              ...
              <p class="smaller" style="font-weight:700;color:var(--blue-deep);margin-top:6px">Referee available · [PERMISSION CONFIRMED?]</p>
            </div>
            <div class="card" style="padding:22px 22px 20px;gap:6px">
    ...
    <section class="wrap sec-tight" aria-labelledby="sec-h">
      <div class="split" style="grid-template-columns:300px minmax(0,1fr)">
        ...
        <div class="grid grid-2">
          ...
          <div class="card" style="padding:24px 22px;gap:9px"><h3>Breach notification</h3><p style="font-size:14.5px;line-height:1.5">We notify you within [X hours] of becoming aware, with what we know, so you can meet your own obligations.</p></div>
        </div>
      </div>
    </section>`,
};
