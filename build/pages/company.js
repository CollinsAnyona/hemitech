    ...
    <section class="wrap sec-tight" aria-labelledby="who-h">
      ...
      <div class="grid grid-2" style="margin-bottom:var(--s7)">
        <figure class="card" style="padding:0;overflow:hidden;gap:0">
          <img class="portrait" style="border-radius:0;border:none;border-bottom:1px solid var(--line);aspect-ratio:4/5;object-fit:cover;object-position:top center" src="/Images/Team/collins-anyona.jpg" alt="Collins Anyona, director of Hemi Tech Co." width="600" height="600" loading="lazy" decoding="async">
          <figcaption style="padding:20px 22px 22px">
            <h3>Collins Anyona</h3>
